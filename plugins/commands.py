...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔍 VIP Group', url='https://t.me/+EGPK142fIwE1ODFk'),
            InlineKeyboardButton('🤖 Netflix For Movies', url='https://t.me/S_S0F')
            ],[
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        if AUTO_DELETE_MODE == True:
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️أنتباه ❗️️❗️❗️</u></b>\n\nهذا الفيلم / المسلسل /سيتم حذفه بعد  <b><u>{AUTO_DELETE} دقيقة</u> 🫥 <i></b>(بسبب مشاكل في حقوق النشر )</i>.\n\n<b><i>Please قم بتحويل الملف الي حافظتك </b>")
            ...
            for x in filesarr:
                try:
                    ...
                    pass
            await k.edit_text("<b>سيتم حذف الفيديوهات !!!</b>")
        return
    ...
    try:
        ...
        if AUTO_DELETE_MODE == True:
            ...
            try:
                ...
                pass
            await k.edit_text("<b>تم حذف الملف بنجاح 🛡️!!!</b>")
        return
    except:
        pass
